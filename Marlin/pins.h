...
#else // DUAL_Y_DRIVE
#  define Y_SENSITIVE_PINS Y0_STEP_PIN, Y0_DIR_PIN, Y0_ENABLE_PIN, Y0_MIN_PIN, Y0_MAX_PIN, \
                           Y1_STEP_PIN, Y1_DIR_PIN, Y1_ENABLE_PIN, Y1_MIN_PIN, Y1_MAX_PIN, \
                           Y2_STEP_PIN, Y2_DIR_PIN, Y2_ENABLE_PIN, Y2_MIN_PIN, Y2_MAX_PIN, \
                           Y3_STEP_PIN, Y3_DIR_PIN, Y3_ENABLE_PIN, Y3_MIN_PIN, Y3_MAX_PIN
#endif // DUAL_Y_DRIVE
